        ...
        <div className="min-h-screen bg-white text-black">
            <nav className="px-6 py-4 flex justify-between items-center">
                ...
                <ConnectKitButton.Custom>
                    {({ isConnected, isConnecting, show, address }) => (
                        <button
                            onClick={show}
                            className="px-4 py-2 bg-black text-white rounded-full font-medium hover:bg-gray-900 transition-all transform hover:scale-105"
                        >
                            {isConnected
                                ? address
                                : isConnecting
            ...
            <main className="max-w-6xl mx-auto px-6 py-20">
                <div className="text-center space-y-8">
                    ...
                    >
                        Join the next generation of digital art collectors.
                        Explore unique NFTs, participate in live auctions, and
                        own pieces of digital history.
                    </p>
                ...
                {/* Features */}
                <div
                    className={`grid md:grid-cols-3 gap-8 mt-20 transition-opacity duration-1000 delay-700 ${
                        showText ? "opacity-100" : "opacity-0"
                    }`}
                >
                    <div className="bg-gray-50 p-6 rounded-xl hover:transform hover:scale-105 transition-all duration-300">
                        ...
                        <p className="text-gray-600">
                            Participate in real-time bidding for exclusive
                            digital artworks
                        </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl hover:transform hover:scale-105 transition-all duration-300">
                        ...
                        <p className="text-gray-600">
                            Discover and collect works from renowned digital
                            creators
                        </p>
                    </div>
                    <div className="bg-gray-50 p-6 rounded-xl hover:transform hover:scale-105 transition-all duration-300">
                        ...
                        <p className="text-gray-600">
                            Browse through carefully curated collections of
                            digital art
                        </p>
                    </div>
                </div>
